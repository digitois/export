...
create index idx_blog_posts_org_status on public.blog_posts (organization_id, status);
create index idx_blog_posts_org_slug on public.blog_posts (organization_id, slug);
create index idx_blog_posts_created on public.blog_posts (organization_id, created_at desc);
...
create index idx_blog_post_views_org on public.blog_post_views (organization_id);
create index idx_blog_post_views_post on public.blog_post_views (blog_post_id);
create index idx_blog_post_views_date on public.blog_post_views (organization_id, viewed_at);
