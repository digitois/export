...
create index idx_leads_org_priority on public.leads (organization_id, priority);
create index idx_leads_org_source on public.leads (organization_id, source);
...
create index idx_lead_activities_due on public.lead_activities (organization_id, due_at);
...
create index idx_lead_follow_ups_org on public.lead_follow_ups (organization_id);
create index idx_lead_follow_ups_lead on public.lead_follow_ups (lead_id);
