...
create index idx_products_org_category on public.products (organization_id, category_id);
create index idx_products_org_slug on public.products (organization_id, slug);
...
create index idx_product_variants_org on public.product_variants (organization_id);
...
create index idx_product_media_org on public.product_media (organization_id);
