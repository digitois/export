...
create index idx_email_contacts_org on public.email_contacts (organization_id);
...
create index idx_email_campaigns_status on public.email_campaigns (organization_id, status);
...
create index idx_email_activities_org on public.email_activities (organization_id);
create index idx_email_activities_campaign on public.email_activities (campaign_id);
create index idx_email_activities_org_event on public.email_activities (organization_id, event);
